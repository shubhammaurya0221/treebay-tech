  ...
  const services = [
    {
      ...
      desc: "We design, engineer, and commission complete green hydrogen production facilities — from electrolysers and hydrogen gas storage systems to distribution infrastructure. Our plants support India's National Green Hydrogen Mission target of 5 MMT annual hydrogen production by 2030.",
